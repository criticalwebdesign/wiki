...
description: Use Figma layout grids to create a multi-column page design.
# draft: true
---
...
<CustomAside type="excerpt" reference="Exercise 4.1.1"></CustomAside>
...
![grid column settings](../../../assets/images/04/04-17-figma-grid-settings.png)
