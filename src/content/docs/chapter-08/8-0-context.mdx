...
<div class="max-w-3xl mx-auto not-content">
  <YoutubeVideo src="https://www.youtube.com/watch?v=rchEbQNMepw" />
</div>

“By tokenizing and building a map of all our semi-literate memes and shit posts, LLMs can—when prompted—produce language that sounds like one of us. [. . .] But no part of this process makes the computer intelligent, sentient, or inclined to ‘kill all humans.’ . . . And that’s what generative AI is: not really living, seemingly not dead, a shimmering contortion of what we thought we think and believed we believe.” —Heydon Pickering, “What’s The Deal with Large Language Models?”
