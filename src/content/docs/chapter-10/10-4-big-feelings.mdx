...
![Screenshot of the Big Feelings web page.](../../../assets/images/10/10-22-big-feelings-finished-2026.png)
...
1. At the end of the sign-up process, you will be prompted to create an organization (to organize users) and a project (to organize clusters and databases). For example, we created a project named `criticalwebdesign`.
1. Login to the Dashboard https://cloud.mongodb.com/ and follow the steps in [Deploy a Free Cluster](https://www.mongodb.com/docs/atlas/tutorial/deploy-free-tier-cluster/) to create a new free-tier cluster. For example, we named our cluster `big-feelings`, left all the default options as they were, and clicked "Create Deployment."
