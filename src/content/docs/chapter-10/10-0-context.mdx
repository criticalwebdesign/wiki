...
### Join xtine's Virtual Punk Band!
![virtual punk band](../../../assets/images/10/10-internationalPussycats.png)
Following the modules in this chapter, including the bonus module on the wiki, xtine and her computer science student, Pragya Singh, made The International Pussycats, a virtual punk band anyone can join. If you ever wanted to be in a band but didn't want to spend all that time practicing, this [virtual punk band](https://virtual-punk-band.vercel.app/) is for you.
