---
title: 3.1 Match a Typeface
description: Select a typeface matching the IKEA identity (Chapter 3 prompt) and incorporate it into your design.
# draft: true
---
...
Using this graphic from the book, follow the steps below to match the Ikea logo typeface (or any) for the chapter 3 prompt.
