...
description: Import a Javascript file into HTML and create a mouseover event listener.
# draft: true
---
...
:::note[Author's Note]
Javascript doesn’t care about whitespace as long as the syntax is correct.
:::
