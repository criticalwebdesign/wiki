...
<CustomAside type="excerpt" reference="Exercise 2.1.2"></CustomAside>
...
<CustomAside type="newmaterial">Prompts for using the eye movement test within the classroom.</CustomAside>

1. Look at a design in process (something you or colleagues are working on)
