...
We cover two ways to publish your project to Vercel. The first [Connect Github to Vercel](#1-connect-github-to-vercel) is recommended for new users. The second tutorial [Vercel Command Line Tool](#2-vercel-command-line-tool) is more advanced but gives you finer control over how it is published. 
