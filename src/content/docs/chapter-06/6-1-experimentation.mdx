...
description: Follow brainstorming suggestions from the book and experiment with diverse layouts of a simple phrase.
# draft: true
---
...
<CustomAside type="excerpt" reference="Exercise 6.1.2"></CustomAside>
...
![ An image of a mood board with works made by women artists and designers](../../../assets/images/06/06-11-moodboard.png)
...
<CustomAside type="excerpt" reference="Exercise 6.1.4"></CustomAside>
...
![logo iterations](../../../assets/images/03/03-19-logo-variations.png)
These logo iterations from chapter 3 prompt outcomes show the above process at work. Building on the original Adobe logo, each new version attempts a different typeface and logo variation. All versions are saved in order to compare them against others, and select the best (or best parts) for the final outcome.
...
![LA Times website exploded](../../../assets/images/06/06-explodeTheWeb-laTimes.png)
...
![The New York Times website](../../../assets/images/06/06-19-nyt-explode.png)
The New York Times website also gets a redesign. 
...
![birds example](../../../assets/images/06/ch6-birds-1.gif)
...
![maintenance example](../../../assets/images/06/ch6-maintenance-3.gif)
...
![baldwin example](../../../assets/images/06/ch6-baldwin-1.gif)
