...
1. List potential solutions for the design brief in chapter 7.
...
<CustomAside type="excerpt" reference="Prompt 7.0">Following are figures showing test results for our prompt using WAVE.</CustomAside>
