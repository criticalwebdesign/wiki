...
description: Install and use the command line to explore your machine and the network
# draft: true
---
...
:::tip[Pro Tip]
View a file’s media type on the command line using: `file --mime-type -b filename`
:::
