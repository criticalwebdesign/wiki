...
<CustomAside type="newmaterial">One way to visualize the packet switching process is through the traceroute command. In this exercise you will use an online tool to show the paths and response times (in milliseconds) to retrieve data from any domain from major datacenters around the globe.</CustomAside>
