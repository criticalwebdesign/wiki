---
title: 1.3 Git and Github Desktop
description: Install Git, Github Desktop, and VS Code so you can build, test, and publish websites from your own computer. 
# draft: true
---
...
:::caution
This setup is not required if you are using Github Codespaces.
:::
...
:::caution
You should be familiar with the [Command Line](./1-2-command-line.md) before completing the following exercises.
:::
